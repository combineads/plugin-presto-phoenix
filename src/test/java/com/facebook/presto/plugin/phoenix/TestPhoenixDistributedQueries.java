        ...
        extends AbstractTestQueries
{
    ...
    @Test
    public void testPhoenixCreatedParameterizedVarchar()
    {
        DataTypeTest.create()
                ...
                .execute(getQueryRunner(), phoenixCreateAndInsert("tpch.phoenix_test_parameterized_varchar"));
    }

    @Test
    public void testPhoenixCreatedParameterizedVarcharUnicode()
    {
        ...
        DataTypeTest.create()
                ...
                .execute(getQueryRunner(), phoenixCreateAndInsert("tpch.phoenix_test_parameterized_varchar_unicode"));
    }

    @Test
    public void testPrestoCreatedParameterizedChar()
    {
        phoenixCharTypeTest().execute(getQueryRunner(), prestoCreateAsSelect("phoenix_test_parameterized_char"));
    }

    @Test
    public void testPhoenixCreatedParameterizedChar()
    {
        phoenixCharTypeTest().execute(getQueryRunner(), phoenixCreateAndInsert("tpch.phoenix_test_parameterized_char"));
    }

    private DataTypeTest phoenixCharTypeTest()
    {
    ...
    @Test
    public void testPhoenixCreatedParameterizedCharUnicode()
    {
        DataTypeTest.create()
    ...
    {
        JdbcSqlExecutor phoenixUnicodeExecutor = new JdbcSqlExecutor(phoenixServer.getJdbcUrl() + "&useUnicode=true&characterEncoding=utf8");
        return new CreateAndInsertDataSetup(phoenixUnicodeExecutor, tableNamePrefix);
    }
